...
$(function() {
    ...
    function InteractiveTerminalViewModel(parameters) {
        ...
        self._setupAutocomplete = function() {
            ...
            input.on(
                ...
                function(event) {
                    ...
                    /*
                     * If focus moved into the autocomplete popup — for example onto the
                     * Marlin documentation link — leave the popup alone so the browser can
            ...
            if (
                ...
                variant.parameters.forEach(function(parameter) {
                    ...
                    $("<span>")
                        ...
                        .html(self._formatHelpText(parameter.description || ""))
                        .appendTo(row);
        ...
        self._formatHelpText = function(text) {
            if (typeof text !== "string" || !text) {
                return "";
            }

            /*
             * Escape all source HTML first. Any HTML present in the output after this
             * point is markup generated by us.
             */
             ...
             * Inline code.
             *
             * Keep this before emphasis processing so Markdown characters inside
             * backticks aren't interpreted.
             */
            const codeSpans = [];
             ...
             * Links.
             *
             * Only allow HTTP(S) URLs or root/protocol-relative links from the Marlin
             * documentation. Other schemes remain plain text.
             */
            ...
            /*
             * Preserve paragraph breaks without introducing a complete Markdown block
             * parser.
             */
            output = output
                .replace(/\r\n?/g, "\n")
            ...
            /*
             * Restore protected code spans last.
             */
            output = output.replace(
                /\x00CODE(\d+)\x00/g,
                function(_, index) {
